...
public class MemberDAO { // member테이블에 crud를 하고 싶으면 MemberDAO를 사용하면 됨.!
	...
	public ArrayList<com.multi.jsp.member.MemberDTO> list() {
//		int result = 0;
		ArrayList<com.multi.jsp.member.MemberDTO> list = new ArrayList<>();
		...
		try {
			...
			while(rs.next()) { // table안에 검색결과인 row가 있는지 체크
				...
				com.multi.jsp.member.MemberDTO bag = new com.multi.jsp.member.MemberDTO();
	...
	public com.multi.jsp.member.MemberDTO one(String id) {
//		int result = 0;
		com.multi.jsp.member.MemberDTO bag = new com.multi.jsp.member.MemberDTO();
		PreparedStatement ps = null;
		ResultSet rs = null;
	...
	public int insert(com.multi.jsp.member.MemberDTO memberDTO) {
		PreparedStatement ps = null;
