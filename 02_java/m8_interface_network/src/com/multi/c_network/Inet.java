...
public class Inet {
    ...
    public static void main(String[] args){
        try{
            ...
            System.out.println("내 주소: " + localIp.getHostAddress());

            InetAddress googleIp = InetAddress.getByName("www.google.com"); //dns 주소를 사용하여 Ip 주소 변환
            System.out.println("구글 서버명: " + googleIp.getHostName());
            System.out.println("구글 서버: " + googleIp.getHostAddress());
